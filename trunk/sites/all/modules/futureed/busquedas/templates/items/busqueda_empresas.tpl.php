<div class="large-<?= $anchoColumnas;?> columns end no-padding">
	<div class="item-lista-grande">
		<div class="row busquedaEmpresas">
			...
			<div class="small-8 columns">
				<div class="contenido">
					...
					<div class="row">
						<div class="large-6 columns">
							<?= t('Ubicacion');?>: <?= $item['calc_usuario_ubicacion'];?>
			                <p><?= t('Seguidores');?>: <?= $item['field_usuario_numero_seguidores']; ?></p>
						</div>
						<div class = "large-6 columns">
							<div class="info">
					...
					<div class = "row">
						<div class = "large-6 columns">
							<div class = "info">
			                    ...
			                    <?php } ?>
			                    <p><?= t('Cursos');?>: <?= $item['calc_numero_cursos']; ?></p>
							</div>
						</div>
						<div class = "large-6 columns">
							<div class = "botones ">
								<a class="btn" value="javascript:void(0);" onClick="console.log('Ver Empresa');"><?= t('Ver Empresa');?></a>
							</div>
						</div>
					</div>
